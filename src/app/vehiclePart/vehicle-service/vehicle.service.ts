...
export class VehicleService {
  ...
  public updateVehicle(vehicleData:IUpdateVehicle): Observable<any>{
    return this._http.put(`http://localhost:8080/vehicles/vehicle/${vehicleData.plateNumber}`, vehicleData);
  }
